...
df_mhz		=	5.25	                        #	Channel width in MHz
time_win_ms	=	10.0	                        #	Time window in ms
time_res_ms	=	0.1		                        #	Time resolution in ms
scindex		=	-4.0	                        #	Scattering index
f_ref_mhz	=	1000.0	                        #	Reference frequency for scattering
