...
#	Function list
#
#	gauss_dynspec(fmhzarr, tmsarr, dfmhz, dtms, specind, peak, wms, locms, dmpccc):
...
def gauss_dynspec(fmhzarr, tmsarr, dfmhz, dtms, specind, peak, wms, locms, dmpccc, pa, l, v, dpadt, rm):
	"""
