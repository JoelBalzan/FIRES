...
dfmhz		=	5.25		#width freq channel (1MHz)								#	Channel width in MHz
twinms		=	10.0		#time window (msec) 									#	Time window in ms
tresms		=	0.1		#time res (msec) 										#	Time resolution in ms
scindex		=	-4.0		#scattering index 									#	Scattering index
frefmhz		=	1000.0		# ref freq (MHz)									#	Reference frequency for scattering
