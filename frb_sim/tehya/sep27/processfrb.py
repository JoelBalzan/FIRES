...
if(exmode=="calcrm"):
	...
	corrdspec	=	unfarot(dsdata.dspec4, dsdata.fmhzarr, rm0)
	tsdata		=	calc_profiles(corrdspec, dsdata.fmhzarr, dsdata.tmsarr, noisespec, startchan, endchan)
	
	if(exmode=="iquv"):
		plot_iquvt(plotdir,corrdspec,tsdata.iquvt,dsdata.fmhzarr,dsdata.tmsarr,[0.0,0.0],[5.0,8.0])
	
	if(exmode=="lvpa"):
		plot_ilvpadst(plotdir,noistks,corrdspec,tsdata,dsdata.fmhzarr,dsdata.tmsarr,[0.0,0.0],[4.0,5.0])
