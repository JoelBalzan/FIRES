...
def plots(fname, FRB_data, mode, startms, stopms, startchan, endchan, rm, outdir, save, figsize):
	#	Plotting function
	...
	if (mode == "all"):
		...
		if(mode=="lvpa"):
			plot_ilv_pa_ds(corrdspec, dsdata.frequency_mhz_array, dsdata.time_ms_array, save, fname, outdir, tsdata, noistks, figsize)
