...
fires -f 191001_sd30 -p pa --ncpu 12 --config-dir ~/Documents/GitHub/FIRES/paper/191001/ -v  --seed 0 --sefd 1.4 --scint --override-param "tau=1.78" -o /home/joel/Documents/GitHub/FIRES/paper/191001/
...
fires -f 191001_sd0 -p pa --ncpu 12 --config-dir ~/Documents/GitHub/FIRES/paper/191001/ -v  --seed 0 --sefd 1.4 --scint --override-param "tau=1.78" "sd_PA=0" -o /home/joel/Documents/GitHub/FIRES/paper/191001/
