...
for cmd in \
  ...
  #"sbatch --job-name=15 --export=ALL,N=15 fires_loop_240318A.sh" \
  "sbatch --job-name=20 --export=ALL,N=20 fires_loop_240318A.sh" \
  #"sbatch --job-name=50 --export=ALL,N=50 fires_loop_240318A.sh" \
  "sbatch --job-name=100 --export=ALL,N=100 fires_loop_240318A.sh" \
  #"sbatch --job-name=200 --export=ALL,N=200 fires_loop_240318A.sh" \
  #"sbatch --job-name=600 --export=ALL,N=600 fires_loop_240318A.sh" \
...
# remaining commented submit examples
